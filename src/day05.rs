...
fn subtest_day05_parse_stacks() {
    ...
    expected.insert(1, Stack{ crates: vec!["Z".to_string(), "N".to_string()]});
    expected.insert(2, Stack{ crates: vec!["M".to_string(), "C".to_string(), "D".to_string()]});
    expected.insert(3, Stack{ crates: vec!["P".to_string()]});
